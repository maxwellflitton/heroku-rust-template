...
mod tests {
    ...
    use data_access_layer::to_do_items::transactions::delete::DeleteOneResponse;
    ...
    async fn test_delete_err() {
        ...
        impl DeleteOne for ReturnErrorMock {
            fn delete_one(id: String, user_id: i32) -> impl Future<Output = DeleteOneResponse> + Send {
                ...
                async {
                    Err(NanoServiceError::new("Some Error".to_string(), nanoservices_utils::errors::NanoServiceErrorStatus::NotFound))
                }
            }
        }
        ...
        match result {
            ...
            Err(e) => {
                assert_eq!(e.status, nanoservices_utils::errors::NanoServiceErrorStatus::NotFound);
